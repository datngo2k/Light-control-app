  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocBuilder<ActionCubit, ActionState>(builder: (context, state) {
          int i = 0;
            ...
            return Background(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Center(
                      child: Text(Jiffy(_selectedValue).format("E dd/MM/yyyy"),
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: ListTile(
                                      leading: Text(listActionBulb[index].idDevice,
                                          style: kTextStyle),
                                      title: listActionBulb[index].getState(),
                                      trailing: Column(
                                        mainAxisAlignment:
                                            MainAxisAlignment.center,
                                        children: [
                                          Text(
                                              Jiffy(listActionBulb[index].date)
                                                  .format("E dd/MM/yyyy"),
